...
async function seedDatabase(dataSource) {
    const ageRangeRepository = dataSource.getRepository(age_range_entity_1.AgeRange);
    const categoryRepository = dataSource.getRepository(toy_category_entity_1.ToyCategory);
    const packRepository = dataSource.getRepository(pack_entity_1.Pack);
    const faqRepository = dataSource.getRepository(faq_entity_1.FAQ);
    // Seed Age Ranges
