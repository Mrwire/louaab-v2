...
let AuthController = class AuthController {
    ...
    async adminLogin(loginDto) {
        const result = await this.authService.loginAdmin(loginDto.email, loginDto.password);
        return {
            success: true,
            data: result,
    ...
    async customerLogin(loginDto) {
        const result = await this.authService.loginCustomer(loginDto.email, loginDto.password);
        return {
            success: true,
            data: result,
            message: 'Connexion réussie',
    ...
    async customerRegister(registerDto) {
        ...
        const loginResult = await this.authService.loginCustomer(registerDto.email, registerDto.password);
        return {
            success: true,
            data: loginResult,
